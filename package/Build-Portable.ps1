...
WHAT THIS IS
  ...
  membranes (solution-diffusion, cross-flow / co- / counter-current). It plugs into
  any CAPE-OPEN Process Modelling Environment (COFE/COCO, etc.). Thermodynamics are
  taken FROM the flowsheet's property package via the Material Object - this unit
  does not carry its own thermo.

REQUIREMENTS (on the target PC)
  - Windows x64
  - .NET Framework 4.8 or later
  - A CAPE-OPEN PME (e.g. COCO/COFE) with a property package (e.g. TEA)
